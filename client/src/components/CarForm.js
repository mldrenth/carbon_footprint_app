...
const CarForm = ({ climateData, handleCarCalculation, co2PerMile, yearlyMileage, fuelType, carSize, hasCar, handleMileageChange, handleFuelSelected, handleSizeSelected, handleHasCarSelected }) => {
